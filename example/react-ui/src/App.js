...
import { WalletProvider, WalletConnectButton } from '@rbflabs/agoric-react-components'
...
//                 - We've sent{' '}
//                 <b>
//                     {sentOffersCount} {sentOffersCount === 1 ? 'offer' : 'offers'}
//                 </b>{' '}
//                 in this session
//             </div>
//             <div>
//                 - Wallet is aware of{' '}
//                 <b>
//                     {walletIsAwareOffersCount} {walletIsAwareOffersCount === 1 ? 'offer' : 'offers'}
//                 </b>
//             </div>
//             <div>
//                 - User has accepted{' '}
//                 <b>
//                     {acceptedOffersCount} {acceptedOffersCount === 1 ? 'offer' : 'offers'}
//                 </b>
//             </div>
//         </div>
//     )
    ...
    if (!agoricInterface || !moolaPursePetname || !awesomezPursePetname) {
        return (
            <div id="Interface-activation">
                ...
                <p>
                    Waiting for Agoric interface to be activated (click <b>Accept</b> in your Agoric wallet)...
                </p>
            </div>
        )
    }
...
function App() {
    return (
        <div className="App">
            <WalletProvider dappName="Agoric-Components-Example" autoConnect={false}>
                <WalletConnectButton />
